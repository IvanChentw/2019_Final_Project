...
'''
    ...
    #For example:
SaveLoc='C:\\Users\\Ivan Chen\\final_project\\wave_1d\\case02\\case02_'
'''
...
'''
    #Please select where you would like to save your file
    #For example:
SaveLoc02='C:\\Users\\Ivan Chen\\final_project\\wave_1d\\case02\\case02_'
'''
for i in range(len(T)):
    SaveImage(T[i],'Case02 t='+str(round(k*i,2)),SaveLoc02+'t='+str(round(k*i,2))+'.png')
