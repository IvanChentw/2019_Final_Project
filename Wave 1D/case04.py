...
#Case4 A triangular wave string
import numpy as np
...
'''
    ...
    #For example:
SaveLoc='C:\\Users\\Ivan Chen\\final_project\\wave_1d\\case04\\case04_'
'''
...
'''
    #Please select where you would like to save your file
    #For example:
SaveLoc02='C:\\Users\\Ivan Chen\\final_project\\wave_1d\\case04\\case04_'
'''
for i in range(len(T)):
    SaveImage(T[i],'Case04 t='+str(round(k*i,2)),SaveLoc02+'t='+str(round(k*i,2))+'.png')
